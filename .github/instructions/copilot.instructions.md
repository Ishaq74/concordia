---
description: 'This file contains detailed instructions for AI agents working on the Concordia project. It covers architecture, conventions, patterns, and workflows that cannot be auto-extracted from the codebase. Always refer to this file for guidance on how to structure code, handle authentication, manage database schemas, implement styling variants, and write tests. For a snapshot of the current project state (dependencies, file tree, schemas, tokens, test inventory), see the auto-generated README files.'
applyTo: '**'
---
