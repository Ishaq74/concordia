...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  // Article management permission check
  const permGuard = guardPermission(locals, "article.create");
  ...
  try {
    ...
    if (action === "create") {
      ...
      await db.insert(blogAuthors).values({
        ...
        givenName: (payload.givenName as Record<string, string>) || null,
        familyName: (payload.familyName as Record<string, string>) || null,
        bio: (payload.bio as Record<string, string>) || null,
        jobTitle: (payload.jobTitle as Record<string, string>) || null,
        ...
        sameAs: (payload.sameAs as Record<string, string>) || null,
        ...
        seoKeywords: (payload.seoKeywords as Record<string, string>) || null,
        canonicalUrl: payload.canonicalUrl ? String(payload.canonicalUrl) : null,
        createdAt: new Date(),
        updatedAt: new Date(),
      });
